 ...
 * separately.
 * @param {Script} scriptSig - the script's first vp (corresponding to the tx input)
 * @param {Script} scriptPubkey - the script's last vp (corresponding to the tx output)
